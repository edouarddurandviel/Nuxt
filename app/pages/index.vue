<template>
      ...
      <div class="row d-flex align-items-center justify-content-center py-vh-5">
        ...
        <div class="col-12 col-xl-8">
          <p class="lead text-secondary">
            We are some sort of DAO working with AI, NFT´s, web 4.0 and the so called
            blockchain...in the Metaverse. You don´t understand a word? No problem, we neither!
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container px-vw-5 py-vh-5">
      <div class="row d-flex align-items-center">
        <div class="col-12 col-lg-7">
          <img
            class="img-fluid rounded-5 mb-n5 shadow"
          ...
          />
          <img
            class="img-fluid rounded-5 ms-5 mb-n5 shadow"
        ...
        <div class="col-12 col-lg-5 bg-dark rounded-5 py-5" data-aos="fade">
          ...
          <h2 class="display-4">
            We constantly adding new images to our website. Does it make sense? No!
          </h2>
        </div>
      </div>
    </div>
  ...
  <div class="bg-black">
    <div class="container px-vw-5 py-vh-5">
      <div class="row d-flex align-items-center">
        ...
        <div
          class="col-12 col-lg-7 bg-dark rounded-5 py-vh-3 text-center my-5"
          data-aos="zoom-in-up"
        >
          <h2 class="display-huge mb-5">
            <span class="fs-4 me-2 fw-light">$</span><span class="border-bottom border-5">499</span
            ><span class="fs-6 fw-light">/day</span>
          </h2>
          <p class="lead text-secondary">
  ...
  <div class="container-fluid px-vw-5 position-relative" data-aos="fade">
    ...
    <div
      class="position-relative py-vh-5 bg-cover bg-center rounded-5"
      style="background-image: url(/img/webp/abstract12.webp)"
    >
      <div class="container bg-black px-vw-5 py-vh-3 rounded-5 shadow">
        <div class="row d-flex align-items-center">
          <div
            class="col-6 d-flex align-items-center bg-dark shadow rounded-5 p-0"
            data-aos="zoom-in-up"
          >
            <div class="row d-flex justify-content-center">
              ...
              <div class="col-12 col-lg-10 col-xl-8 text-center my-5">
                <p class="lead border-bottom pb-4 border-secondary">
                  "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
          ...
          <div class="col-5 offset-1">
            ...
            <h2
              class="display-huge fw-bolder border-top border-secondary pt-5 mt-5"
...
// env variables specified seperatly from build.
// dev - staging - production
// keep secrets at the backend
const runtimeConfig = useRuntimeConfig();

// taken into account when running build process.
// not safe. all secrets are exposed to client
